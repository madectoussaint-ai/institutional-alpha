...
HEADERS={
    "User-Agent":"InstitutionalAlpha/1.7.1 educational-research (https://github.com/madectoussaint-ai/institutional-alpha)",
...
def get_text(url):
    r=requests.get(url,headers=HEADERS,timeout=TIMEOUT)
    r.raise_for_status(); time.sleep(0.12); return r.text
